...
- [SmashGG Exporter](https://github.com/mli42/smashgg-exporter) - Fetches tournaments data from [start.gg](https://www.start.gg) and saves them into a PostgreSQL database, and generate CSV (Python, GraphQL)
